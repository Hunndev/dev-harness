...
> **지위**: 이 단계는 `/hb-shared:seed` 주문서(요구사항 MUST/SHOULD/NICE 섹션)에 **흡수**되었다 — 기본 흐름에서는 seed가 이 단계를 대신한다. 요구사항만 따로 정리하고 싶을 때 opt-in으로 호출하며, 아래 산출물 형식은 그때 쓰는 canonical 형식이다.
