...
- Feature: `commands/feature/auto.md` or `commands/feature/deep.md` (contract pre-check: `commands/feature/contract-check.md`)
...
- `hb-chat feature contract-check` or `/hb-chat:feature:contract-check`
- `hb-chat shared update-docs` or `/hb-chat:shared:update-docs`
- `hb-chat shared verify` or `/hb-chat:shared:verify`
- `hb-chat shared review-gates` or `/hb-chat:shared:review-gates`
...
7. New ADRs originate from the planning/adr track only — maintenance/feature verify conformance via the shared methodology core: `hb-shared maintenance convention-check` (file: `SHARED/commands/maintenance/convention-check.md` in the dev-harness repo).
