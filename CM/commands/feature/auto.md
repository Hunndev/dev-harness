...
> **Tier 선택**
> - `/hb-cm:feature:auto` — **이 문서.** 일반 기능 기본값. F3 유사 구현 조사, F5 평가기준 재생성, F9 PR본문 Fork를 생략한다.
> - `/hb-cm:feature:deep` — F1~F11 full ceremony. 복잡 기능, 이벤트 흐름 상호작용이 크거나 PR 문서화가 중요할 때 사용.
